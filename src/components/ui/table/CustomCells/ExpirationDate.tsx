 ...
 const BatchExpiration = ({ expirationDate }: BatchExpirationProps) => {
   ...
   if (diffDays <= 0) {
     // CASO 1: YA VENCIDO
     statusStyles = "bg-red-100 text-red-700 font-bold border border-red-200";
     label = "VENCIDO";
   } else if (diffDays <= 90) {
   ...
   return (
     <div className="flex flex-col gap-1 min-w-[140px]">
       ...
       <div className={`text-[10px] px-2 py-0.5 rounded-md w-fit uppercase tracking-wider ${statusStyles}`}>
