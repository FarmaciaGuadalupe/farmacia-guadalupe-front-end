 ...
 */
const getPaginationRange = (currentPage: number, totalPages: number, siblingCount: number = 1): (string | number)[] => {
...
export default function PaginationControl<T>({ table }: PaginationControlProps<T>) {
  ...
  return (
    <div className="flex items-center justify-between gap-4 mt-4 flex-wrap px-2">
      ...
      <div className="flex items-center gap-2">
        <span className="text-sm text-gray-700 dark:text-gray-300"><FormattedMessage id='show'/></span>
        <select
          value={pageSize}
          onChange={e => {
