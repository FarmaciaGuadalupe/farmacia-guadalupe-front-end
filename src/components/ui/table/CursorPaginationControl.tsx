    ...
    <div className="flex items-center justify-between gap-4 mt-4 px-2 flex-wrap">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <span className="hidden sm:inline"><FormattedMessage id="prev" defaultMessage="Anterior" /></span>
        </Button>
        ...
        <Button
          ...
          className="disabled:opacity-50 px-3 py-1.5 flex items-center gap-1"
        >
          <span className="hidden sm:inline"><FormattedMessage id="next" defaultMessage="Siguiente" /></span>
